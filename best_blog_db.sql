...
--
-- Host: localhost    Database: best_blog_db
-- ------------------------------------------------------
...
CREATE TABLE `blog_categories` (
  ...
  CONSTRAINT `blog_categories_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE
...
--
-- Dumping events for database 'best_blog_db'
--

--
-- Dumping routines for database 'best_blog_db'
--
...
-- Dump completed on 2025-04-11  2:01:29
